...
#Função para calcular o log da função de densidade alvo dos graus de liberdade para um determinado grau de liberdade
...
#Função de algoritmo MH adaptativo para geração do próximo valor do graus de liberdade v
#Entradas: numero da iteração it (escalar), variancia da variancia U (vetor), graus de liberdade anterior na cadeia nu.prev (escalar), log da variavel adaptativa lambda llb (escalar), variavel adaptativa media mi (escalar), variavel adaptativa covariancia s2 (escalar)
...
#Função para geração dos valores de U no tempo
